...
Your data contract is the heart of your application. It lives at [`prisma/contact.prisma`](prisma/contact.prisma) and describes your models:
...
export default definePrismaConfig({
  orm: ormConfig({
    contract: './prisma/contact.prisma',
    db: {
...
npx prisma db init             # Create collections in the database
...
| File | Purpose |
|---|---|
| [`prisma/contact.prisma`](prisma/contact.prisma) | Your data contract — define your models here |
...
1. Edit [`prisma/contact.prisma`](prisma/contact.prisma) to add or change models.
